...
export default function HeaderStyle3({companyProfile}) {
  // sticky header
  ...
  return (
    <>
      <header className="main-header main-header-one main-header-two main-header-three">
        <div
          id="sticky-header"
                ...
                <div className="menu-area__inner">
                  <div className="mobile-nav-toggler align-items-center">
                    <div className="site-ligo">
                      ...
                      {companyProfile ?
                          <img
                            src={`${baseURL}/public/image/${companyProfile.companyLogoUrl}`}
                            alt="site-logo"
                            height={40}
                            width={105}
                          /> :
